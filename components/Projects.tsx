  ...
  const projects = [
    {
      ...
      description:
        "A social interaction platform where users can move avatars in a shared 2D space and engage in real-time text, audio, and video communication when they come near each other. Real-time synchronization of movements using WebSockets.",
      technologies: [
        "Next.js",
        "Node.js",
        "Express",
      ...
      status: "Ongoing",
      github: "https://github.com/kedar000/meta-verse-2d"
    },
    {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              ...
              <Card className="relative flex flex-col justify-between h-full bg-white/50 dark:bg-gray-800/50 backdrop-blur-md shadow-xl hover:shadow-2xl transition-shadow duration-300 border-2 border-transparent group-hover:border-blue-500/20">
                <CardHeader>
